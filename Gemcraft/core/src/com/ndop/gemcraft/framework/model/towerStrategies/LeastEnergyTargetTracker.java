 ...
 * Cette stratégie recherche l'ennemi ayant le moins d'énergie.
 * @version 1.0
 */
public class LeastEnergyTargetTracker extends ITargetTracker{
	...
	public String toString(){
		return ResourceManager.bundle.get("ennemiMoinsEnergie");
	}
